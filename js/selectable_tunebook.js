...
(function() {
  function displaySelectTable(searchTerm, results, store) {
    var tuneTable = document.getElementById('tunebook');
    var tunesCount = document.getElementById('tunes-count');
    var tunesCounter = 0;

    // create table headers
    var appendString = '<table style="width:60%"  align="center" id="search-results" class="tablesorter"> \
<thead> \
<tr> \
  <th style="width:10%;">Print Tune</th> \
  <th style="width:30%;">Tune Name &#x25B2;&#x25BC;</th> \
  <th style="width:5%;">Key<br />&#x25B2;&#x25BC;</th> \
  <th style="width:10%;">Rhythm<br />&#x25B2;&#x25BC;</th> \
</tr> \
</thead> \
<tbody>';
    ...
    tuneTable.innerHTML = appendString;
  ...
  function createTableRow(item) {
        ...
        tableRow += '<tr>';
        tableRow += '<td><input name="location" type="checkbox" value="' + item.tuneID + '"/></td>';
  ...
  displaySelectTable(searchTerm, results, window.store);
