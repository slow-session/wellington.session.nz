---
layout: page
title: Wellington New Slow Session
permalink: /new_slowsession/
---
...
We pick four tunes for homework each month, and we’ll play them during the slow session.

{% assign legend="Tunes of the month" %}
...
These are the previous <span id="tunesCount"></span> slow session tunes of the week.
